...
const { cosineSimilarity, embedTexts } = require("../src/memory/memory-vector.cjs");
const { searchChatHistory } = require("../src/memory/chat-vector-memory.cjs");
const { loadChatVectorV2Index } = require("../src/memory/chat-vector-memory-v2.cjs");
